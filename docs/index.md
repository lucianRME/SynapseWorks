...
- [Synapse configuration](synapse/configuration.md)
- [Synapse security and data](synapse/security-data.md)
- [Synapse troubleshooting](synapse/troubleshooting.md)
- [Decision Register overview](decision-register/overview.md)
- [Decision Register quickstart](decision-register/quickstart.md)
- [Decision Register detections](decision-register/detections.md)
- [Decision Register configuration](decision-register/configuration.md)
